...
LCF_TRAPVEC1_START = 0x80200000;
LCF_TRAPVEC2_START = 0x80400000;

LCF_STARTPTR_CPU0 = 0x80000000;
LCF_STARTPTR_CPU1 = 0x80200100;
LCF_STARTPTR_CPU2 = 0x80400100;

LCF_STARTPTR_NC_CPU0 = 0xA0000000;
LCF_STARTPTR_NC_CPU1 = 0xA0200100;
LCF_STARTPTR_NC_CPU2 = 0xA0400100;
...
MEMORY
{
    ...
    pfls1 (rx!p): org = 0x80200000, len = 2M
    pfls1_nc (rx!p): org = 0xa0200000, len = 2M

    pfls2 (rx!p): org = 0x80400000, len = 2M
    pfls2_nc (rx!p): org = 0xa0400000, len = 2M
