...
C_DEPS += \
./0_Src/BaseSw/iLLD/TC37A/Tricore/Psi5s/Psi5s/IfxPsi5s_Psi5s.d 


# Each subdirectory must supply rules for building sources it contributes
0_Src/BaseSw/iLLD/TC37A/Tricore/Psi5s/Psi5s/%.o: ../0_Src/BaseSw/iLLD/TC37A/Tricore/Psi5s/Psi5s/%.c
	@echo 'Building file: $<'
